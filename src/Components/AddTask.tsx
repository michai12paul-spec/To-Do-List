...
const AddTask = ({ addNewTask, showAddTask, showAddTastComponent }) => {
  ...
  return (
    <div className="w-6/8">
      <form>
        <div>
          <label htmlFor="task" className="block mb-2 text-lg font-medium text-gray-900 dark:text-black"></label>
